...
<body class="antialiased">
    <div
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            @guest
                <a href="public/login">Login</a><br><br>
                <h2>ENLACES</h2>
                <p>Enlaces a las diferentes secciones de nuestra base de datos</p>

                <a href="select_class.php">ENLACE A LAS CLASES</a><br><br>
                <a href="select_courses.php">ENLACE A LOS CURSOS</a><br><br>
